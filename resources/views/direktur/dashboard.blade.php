                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        @if($isOverdue)
                                            <span class="text-xs text-red-500 flex items-center gap-1">
                                                ...
                                                +{{ \App\Models\ProjectTask::formatDurationFromDays($daysOverdue) }} terlambat
                                            </span>
                                        @endif
                                    </div>
                                @else
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                            ...
                            @if($deadline)
                                ...
                                @if($isOverdue)
                                    <p class="text-xs font-semibold text-red-400">+{{ \App\Models\ProjectTask::formatDurationFromDays($daysOverdue) }} terlambat</p>
                                @endif
                            @else
